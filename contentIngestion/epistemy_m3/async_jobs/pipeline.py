...
from epistemy_m3.embedding.persist import stamp_tenant, embed_chunks, persist_chunks
from epistemy_m3.extract.base import get_extractor
from epistemy_m3.chunking import Chunker
from epistemy_m3.config import Settings
from epistemy_m3.constants import MAX_CHUNKS_FOR_GRAPH, LLM_MAX_TOKENS_GENERATION
...
class IngestPipeline:
    ...
    def _do_graph_build(self, msg: IngestMessage) -> None:
        ...
        from epistemy_m3.app.factory import db_connection

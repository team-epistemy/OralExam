...
export default function TakeExam(props: { assignmentId?: string; preview?: boolean; onExit?: () => void } = {}) {
  ...
  const showDraftScores = isPractice || preview;
  ...
  const { meta: transcriptMeta, entries: transcript } = examTranscript(questions, qData, {
    showDraftScores, overallScore: edsScore, answered: attemptedCount,
  });

  function downloadTranscript() {
    downloadTranscriptPdf(transcriptMeta, transcript);
  }
